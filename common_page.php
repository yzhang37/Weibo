...
//           url://-------------------------------------------------------需要填写php的URL
//			 async: false,
//           data: {mail:$("#mail").val(), pwd:$("#pwd").val()},//向服务器传递用户昵称和密码，数据库需要确认用户名和密码
//           success: function(data){//需要返回“登录成功”或者“登录失败”
//			        var types = data;
//                  if (types.toString() != "登录成功") {
//					     $.cookie("mail", $("#mail").val(), { path: "/", expiress: 1});					
			...
			<div class="row clearfix" >
				...
				<div class="col-md-2 column">
					...
					<ul class="nav nav-tabs nav-stacked" style="position:fixed;width:170px;top:60px;font-size:18px;background-color:#E8E8E8;opacity:0.8;">
								<li class="active">
									 <a href="http://localhost/index.php" ><span class="glyphicon glyphicon-flag" style="color: rgb(0,0,0);"> 热门</span></a>
								</li>
								<li>
			...
			<div class="row clearfix">
			    ...
			    <form class="form-horizontal" role="form">
				          <div class="form-group">
					         <label for="inputEmail3" class="col-sm-3 control-label" id="mail">邮箱</label>
					         <div class="col-sm-9">
